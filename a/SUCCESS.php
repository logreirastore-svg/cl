...
<html>
    ...
    <body>         
        ...
        <img src="../img/logo.svg" width="260" style="margin-top: 48px;margin-bottom: 34px;">
         ...
         <div class="titulo-app">¡Solicitud Exitosa!</div> 
         <br>
        <img src="../img/finalizar2.jpg" width="90">
        <br>
        <br>
        <div class="descripcion-app">Su crédito será desembolsado en las próximas 24 horas en su cuenta de ahorros.</div> 
        <br>
